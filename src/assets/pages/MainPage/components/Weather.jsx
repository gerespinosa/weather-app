...
export const Weather = ({place, scale}) => {
  ...
  return (
    <div className='flex flex-col gap-12'>
        ...
        <div className='flex flex-col items-center justify-between my-24 md:my-12' 
        onClick={() => navigate(`/${place}/${Date().toString().substring(0,21)}`)}>
        ...
        place={place} 
        to={`/${place}`} 
        className={`flex justify-center mb-12 items-center gap-2 ${theme === 'Dark' ? 'text-orange-500' : 'text-purple-500'}`}>Next days<i className="fa-solid fa-circle-arrow-right"></i></Link>
    </div>
  )
}
